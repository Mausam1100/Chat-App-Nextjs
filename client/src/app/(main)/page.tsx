...
export default function Home() {
  ...
  return (
    <div className="w-full h-full max-w-[1600px] mx-auto sm:min-h-0 grid grid-cols-4 bg-[#2d3542] text-white">
      
      <div className={`p-3 ${!showChatBox ? 'col-span-4' : 'hidden'} sm:col-span-1 h-[calc(100dvh-63px)] sm:h-full sm:block min-h-0`}>
        <ChatSideBar />
      </div>
